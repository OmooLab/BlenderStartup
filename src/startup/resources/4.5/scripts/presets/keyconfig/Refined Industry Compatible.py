...
[("3D View",
 ...
 ("Node Editor",
  ...
  {"items":
   [("node.na_arrange_selected", {"type": 'A', "value": 'PRESS', "shift": True, "ctrl": True}, None),
    ("node.na_recenter_selected", {"type": 'G', "value": 'PRESS', "alt": True}, None),
    ("node.select",
     {"type": 'LEFTMOUSE', "value": 'CLICK'},
     {"properties":
