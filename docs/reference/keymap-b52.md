...
基线来源：[Blender 官方 `b52` Blender Default 源文件](https://raw.githubusercontent.com/blender/blender/blender-v5.2-release/scripts/presets/keyconfig/keymap_data/blender_default.py)。
